    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("title") ? ' has-error' : '' }}'>
                ...
                {!! Form::text("title", old("title"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('broadcast::broadcasts.form.title')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("subcategories") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('subcategories', $subcategory, old("subcategories"), ['multiple'=>'multiple', 'name'=>'subcategories[]', 'class' => 'select-multiple form-control']) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("gender") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('gender', $gender, old("gender"), ['multiple'=>'multiple', 'name'=>'gender[]', 'class' => 'select-multiple-small form-control']) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("age_band") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('age_band', $age_band, old("age_band"), ['multiple'=>'multiple', 'name'=>'age_band[]', 'class' => 'select-multiple-medium form-control']) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("cities") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('cities', $city, old("cities"), ['multiple'=>'multiple', 'name'=>'cities[]', 'class' => 'select-multiple form-control']) !!}
