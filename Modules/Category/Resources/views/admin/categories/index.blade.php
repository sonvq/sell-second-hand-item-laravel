                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="data-table table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th>{{ trans('category::categories.table.id') }}</th>
                                <th>{{ trans('category::categories.table.name') }}</th>
                                <th>{{ trans('category::categories.table.status') }}</th>
                                <th>{{ trans('core::core.table.created at') }}</th>
                                <th>{{ trans('category::categories.table.updated at') }}</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php $categoryStatusArr = config('asgard.category.config.status'); ?>
                                    <?php if(isset($categoryStatusArr[$category->status]) && !empty($categoryStatusArr[$category->status])) : ?> 
                                        {{ $categoryStatusArr[$category->status] }}
                                    <?php else: ?>
                                        {{ $category->status }}
                                    <?php endif; ?>
                                </td>
