        ...
        <div class="col-sm-3">
            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                ...
                {!! Form::select('type', ['change_password' => 'Change Password',
                                          ...
                                          'welcome_email' => 'Welcome Email'],        old("type"), ['class' => 'form-control']) !!}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class='form-group{{ $errors->has("content") ? ' has-error' : '' }}'>
                ...
                {!! Form::textarea("content",old("content"), ['id' => 'contentEmail', 'class' => 'form-control ', 'data-slug' => 'source']) !!}
        ...
        <div class="col-sm-3">
            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                ...
                {!! Form::select('status', ['publish' => 'Publish',
                                          'draft' => 'Draft'],         old("status"), ['class' => 'form-control']) !!}
