    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("price_amount") ? ' has-error' : '' }}'>
                ...
                {!! Form::number("price_amount", old("price_amount"), ['class' => 'form-control', 'required' => 'required', 'type' => 'number', 'min' => '1', 'data-slug' => 'source', 'placeholder' => trans('promote::promotes.form.price_amount')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("number_of_date_expired") ? ' has-error' : '' }}'>
                ...
                {!! Form::number("number_of_date_expired", old("number_of_date_expired"), ['class' => 'form-control', 'required' => 'required', 'type' => 'number', 'min' => '1', 'data-slug' => 'source', 'placeholder' => trans('promote::promotes.form.number_of_date_expired')]) !!}
