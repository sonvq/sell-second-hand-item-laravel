    ...
    <div class="row">
        <div class="col-sm-4">            
            <div class='form-group{{ $errors->has("appuser_id") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('appuser_id', $appusers, old("appuser_id"), ['class' => 'selectize', 'id' => 'appuser_id']) !!}
        ...
        <div class="col-sm-4">            
            <div class='form-group{{ $errors->has("item_id") ? ' has-error' : '' }}'>
                ...
                <div class="item_wrapper">
                    {!! Form::select('item_id', $items, old("item_id"), ['class' => '', 'id' => 'item_id']) !!}
                </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("total_promo_days") ? ' has-error' : '' }}'>
                ...
                {!! Form::number("total_promo_days", old("total_promo_days"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.total promo days')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("promo_period_from") ? ' has-error' : '' }}'>
                ...
                {!! Form::text("promo_period_from", old("promo_period_from"), ['id' => 'promo_period_from', 'readonly' => true, 'class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.promo period from')]) !!}
        ...
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("promo_period_to") ? ' has-error' : '' }}'>
                ...
                {!! Form::text("promo_period_to", old("promo_period_to"), ['id' => 'promo_period_to', 'readonly' => true, 'class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.promo period to')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">            
            <div class='form-group{{ $errors->has("payment_mode") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('payment_mode', $paymentMode, old("payment_mode"), ['class' => 'selectize', 'id' => 'payment_mode']) !!}
    ...
    <div class="row">
        <div class="col-sm-4">            
            <div class='form-group{{ $errors->has("transaction_type") ? ' has-error' : '' }}'>
                ...
                {!! Form::select('transaction_type', config('asgard.receipt.config.transaction_type'), old("transaction_type"), ['class' => 'selectize', 'id' => 'transaction_type']) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("transaction_ref_id") ? ' has-error' : '' }}'>
                ...
                {!! Form::text("transaction_ref_id", old("transaction_ref_id"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.transaction ref id')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("remarks") ? ' has-error' : '' }}'>
                ...
                {!! Form::textarea("remarks", old("remarks"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.remarks')]) !!}
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class='form-group{{ $errors->has("amount_due") ? ' has-error' : '' }}'>
                ...
                {!! Form::text("amount_due", old("amount_due"), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('receipt::receipts.form.amount due')]) !!}
